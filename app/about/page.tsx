        ...
        <div className="flex flex-wrap ">
            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div className="relative lg:max-w-md">
                    <Image src={image1} alt="aboutimage"
                        className="relative z-10 object-cover w-full rounded h-96"/>
                    <div
                        className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-slate-500 rounded shadow dark:border-slate-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800 ">
                        <p className="text-lg font-semibold md:w-72">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                className="absolute top-0 left-0 w-16 h-16 text-slate-700 dark:text-gray-300 opacity-10"
                                viewBox="0 0 16 16">
                                <path
            ...
            <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                <div className="pl-4 mb-6 border-l-4 border-slate-500 ">
                ...
                <Link href="#"
                    className="px-4 py-2 text-gray-100 bg-slate-500 rounded dark:bg-slate-400 dark:hover:bg-slate-500 hover:bg-slate-600">
                    Learn more
                </Link>
            </div>
        </div>
